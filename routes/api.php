...
use App\Http\Controllers\MasterOutcomeHutangController;
use App\Http\Controllers\MasterOutcomePaymentController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::apiResource('master-outcome-hutangs', MasterOutcomeHutangController::class);
    Route::apiResource('master-outcome-payments', MasterOutcomePaymentController::class);
